...
\hypersetup{
  pdftitle={Session 10: Repeated Measures and Longitudinal Analysis I},
...
\title{Session 10: Repeated Measures and Longitudinal Analysis I}
\author{Levi Waldron}
\date{}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{gafit1 <-}\StringTok{ }\NormalTok{nlme}\OperatorTok{::}\KeywordTok{lme}\NormalTok{(bweight }\OperatorTok{~}\StringTok{ }\NormalTok{birthord, }\DataTypeTok{data=}\NormalTok{ga, }
    \DataTypeTok{random=}\OperatorTok{~}\NormalTok{birthord}\OperatorTok{|}\NormalTok{momid,}
    \DataTypeTok{na.action=}\NormalTok{na.omit,}
    \DataTypeTok{control=}\KeywordTok{list}\NormalTok{(}\DataTypeTok{msMaxIter=}\DecValTok{600}\NormalTok{, }\DataTypeTok{msMaxEval=}\DecValTok{600}\NormalTok{, }
                 \DataTypeTok{sing.tol=}\FloatTok{1e-20}\NormalTok{, }\DataTypeTok{msVerbose=}\OtherTok{FALSE}\NormalTok{))  }
\end{Highlighting}
\end{Shaded}

Note: the control argument increases the max \# iterations to allow
convergence. If \texttt{msVerbose=TRUE}, it produces verbose output.
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{intervals}\NormalTok{(gafit1, }\DataTypeTok{which =} \StringTok{"fixed"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
